...
VOID CFirstPersonCamera::FrameMove( FLOAT fElapsedTime )
{
    ...
    if( (m_bEnablePositionMovement && m_bLeftRightRotate) || ( m_nActiveButtonMask & m_nCurrentButtonMask ) ||
